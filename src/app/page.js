...
function BOQView({ costs, acres }) {
  const group1 = [
    ...
    { item: '1.1 Boundary Wall & Elevation', qty: costs.boundRft + ' Rft', unit: '2.4K/Rft', cost: costs.items.wall + costs.items.fancyWall },
    ...
    { item: '2.2 Livestock Facility & Stores', qty: costs.animalShedMarla + ' M', unit: '350K/M', cost: costs.items.animalShed + costs.items.fodder },
  ...
  const group2 = [
    ...
    { item: '3.2 Smart Irrigation & Pumps', qty: acres + ' Ac', unit: '200K/Ac', cost: costs.items.drip + costs.items.filtration + costs.items.pressureTank },
    { subtotal: 'Utilities Subtotal', cost: costs.energy + costs.water },
    { section: '4. Livestock & Production' },
    { item: '4.1 Sahiwal Cows', qty: costs.cowCount + ' Nos', unit: '550K/Ea', cost: costs.items.cows },
    { item: '4.2 Nili Ravi Buffaloes', qty: costs.buffCount + ' Nos', unit: '750K/Ea', cost: costs.items.buffs },
